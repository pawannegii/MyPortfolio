        ...
        <section id="contact">
          <FadeIn>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', maxWidth: '800px', margin: '0 auto' }}>
              ...
              <a href="https://github.com/pawannegi" target="_blank" rel="noopener noreferrer" className="glass-card project-card" style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '16px', textDecoration: 'none' }}>
              ...
              <a href="https://linkedin.com/in/pawannegi" target="_blank" rel="noopener noreferrer" className="glass-card project-card" style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '16px', textDecoration: 'none' }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-color)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)' }}>
              ...
              <a href="https://leetcode.com/pawannegi" target="_blank" rel="noopener noreferrer" className="glass-card project-card" style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '16px', textDecoration: 'none' }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-color)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)' }}>
                  <Code size={24} />
                </div>
                <div>
              ...
              <a href="https://hackerrank.com/pawannegi" target="_blank" rel="noopener noreferrer" className="glass-card project-card" style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '16px', textDecoration: 'none' }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-color)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)' }}>
