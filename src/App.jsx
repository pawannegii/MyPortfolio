      ...
      <main className="container">
        ...
        <section id="contact">
          <FadeIn>
            ...
            <div className="social-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', maxWidth: '800px', margin: '0 auto' }}>

              <a href="https://github.com/pawannegii" target="_blank" rel="noopener noreferrer" className="glass-card project-card social-card" style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '16px', textDecoration: 'none' }}>
                <div className="social-icon" style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-color)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)' }}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.2c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4" /><path d="M9 18c-4.51 2-5-2-7-2" /></svg>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left' }}>
                  <h3 style={{ fontSize: '1.1rem', margin: 0, color: 'var(--text-primary)' }}>GitHub</h3>
                  <span style={{ fontSize: '0.9rem', marginTop: '4px', color: 'var(--text-secondary)' }}>@pawannegii</span>
                </div>
              </a>

              <a href="https://www.linkedin.com/in/pawannegii/" target="_blank" rel="noopener noreferrer" className="glass-card project-card social-card" style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '16px', textDecoration: 'none' }}>
                <div className="social-icon" style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-color)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left' }}>
                  <h3 style={{ fontSize: '1.1rem', margin: 0, color: 'var(--text-primary)' }}>LinkedIn</h3>
                  <span style={{ fontSize: '0.9rem', marginTop: '4px', color: 'var(--text-secondary)' }}>Connect with me</span>
                </div>
              </a>

              <a href="https://leetcode.com/u/pawannegi2006/" target="_blank" rel="noopener noreferrer" className="glass-card project-card social-card" style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '16px', textDecoration: 'none' }}>
                <div className="social-icon" style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-color)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)' }}>
                  <Code size={24} />
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left' }}>
                  <h3 style={{ fontSize: '1.1rem', margin: 0, color: 'var(--text-primary)' }}>LeetCode</h3>
                  <span style={{ fontSize: '0.9rem', marginTop: '4px', color: 'var(--text-secondary)' }}>Solve problems</span>
                </div>
              </a>

              <a href="https://www.hackerrank.com/profile/pawan_negi" target="_blank" rel="noopener noreferrer" className="glass-card project-card social-card" style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '16px', textDecoration: 'none' }}>
                <div className="social-icon" style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-color)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)' }}>
                  <TerminalSquare size={24} />
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left' }}>
                  <h3 style={{ fontSize: '1.1rem', margin: 0, color: 'var(--text-primary)' }}>HackerRank</h3>
                  <span style={{ fontSize: '0.9rem', marginTop: '4px', color: 'var(--text-secondary)' }}>Coding Challenges</span>
                </div>
              </a>
